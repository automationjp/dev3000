...
export default function LogsClient({ version, initialData }: LogsClientProps) {
  ...
  const connectSSE = useCallback(() => {
    ...
    const getBaseUrl = () => {
      ...
      if (typeof window !== "undefined" && (window as unknown as { __MCP_BASE_URL__?: string }).__MCP_BASE_URL__) {
        return (window as unknown as { __MCP_BASE_URL__?: string }).__MCP_BASE_URL__
      }
